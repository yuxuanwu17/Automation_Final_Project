...
def rf_passive_learning(method="random sampling", Beta=1):
    ...
    result_logging(accuracy_scores, f"rf/{method}_{sys.argv[2]}_rf_acc_res.txt")
    result_logging(f1_scores, f"rf/{method}_{sys.argv[2]}_rf_f1_res.txt")
    result_logging(recall_scores, f"rf/{method}_{sys.argv[2]}_rf_recall_res.txt")
    result_logging(precision_scores, f"rf/{method}_{sys.argv[2]}_rf_precision_res.txt")
    result_logging(MCCs, f"rf/{method}_{sys.argv[2]}_rf_mcc_res.txt")
    result_logging(auROCs, f"rf/{method}_{sys.argv[2]}_rf_auROC_res.txt")
    result_logging(auPRCs, f"rf/{method}_{sys.argv[2]}_rf_auPRC_res.txt")
    result_logging(learning_round, f"rf/{method}_{sys.argv[2]}_rf_learning_round_res.txt")
...
def lr_passive_learning(method="random sampling"):
    ...
    result_logging(accuracy_scores, f"lr/{method}_{sys.argv[2]}_lr_acc_res.txt")
    result_logging(f1_scores, f"lr/{method}_{sys.argv[2]}_lr_f1_res.txt")
    result_logging(recall_scores, f"lr/{method}_{sys.argv[2]}_lr_recall_res.txt")
    result_logging(precision_scores, f"lr/{method}_{sys.argv[2]}_lr_precision_res.txt")
    result_logging(MCCs, f"lr/{method}_{sys.argv[2]}_lr_mcc_res.txt")
    result_logging(auROCs, f"lr/{method}_{sys.argv[2]}_lr_auROC_res.txt")
    result_logging(auPRCs, f"lr/{method}_{sys.argv[2]}_lr_auPRC_res.txt")
    result_logging(learning_round, f"lr/{method}_{sys.argv[2]}_lr_learning_round_res.txt")
